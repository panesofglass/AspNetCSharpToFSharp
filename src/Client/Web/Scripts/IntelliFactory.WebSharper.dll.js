(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Arrays,Operators,Array,Seq,Unchecked,Enumerator,Number,Char,Util,Concurrency,setTimeout,Date,Scheduler,DateTime,Json,JavaScript,List,T,Error,Math,Remoting,XhrProvider,JSON,Enumerable,Strings,String,Pervasives;
