(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Unchecked,Arrays,List,Control,_FSharpEvent_1,Util,Event,_Event_1,EventModule,HotStream,_HotStream_1,Observable,Observer,Operators,_Observable_1,T,ObservableModule;
    ...
    Control:{
     ...
     Observable:{
      ...
      CombineLatest:function(io1,io2,f)
      {
       ...
       f1=function(o)
       {
        var lv1,lv2,update,o1,onNext,o2,onNext1,d1,d2,dispose;
        lv1={
         contents:{
          $:0
         }
      ...
      Merge:function(io1,io2)
      {
       ...
       f=function(o)
       {
        var completed1,completed2,disp1,x,f1,disp2,x1,f2,dispose;
        completed1={
         contents:false
        };
        completed2={
